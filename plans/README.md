...
| 007 | Экзамен (evals), журнал aiLog, доки, поглощение спайка | P1 | M–L | 006 | DONE (commit `61ae61e`, ветка `feat/plans-001-003`; unit ✓ (794 теста, 61 файл, все зелёные); eval: 1/40 прошло (daily quota); журнал ✓) |
