...
const SPLIT: ParamSuggestions = {
  ...
  [WHOLE_NODE_KEY]: [
    howNode("split-how", "Объясни простыми словами, как работает нода Разделение: что она делает, какие у неё параметры (по чему делит, сколько веток) и когда её стоит применять."),
