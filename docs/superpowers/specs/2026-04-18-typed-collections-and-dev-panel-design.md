...
Словари «Максимальный / Высокий / Средний / Низкий» — 4 уровня сегментации. Термин «Максимальный» согласован с существующим `step-3-segments.tsx`, где он уже используется в UI мастера.
